...
Background:
  ...
  Scenario:  Logged User shall add different products to shopping cart
    ...
    #second product
    When user enter "Adobe Photoshop CS4" in search box
    And user click on product "Adobe Photoshop CS4"
    And user click on add to cart button
    Then product "Adobe Photoshop CS4" shall be added to cart
  ...
  Scenario:  Logged User shall add different products to wishlist
    ...
    And user click on product "Adobe Photoshop CS4"
    And user click on add to wishlist button
    Then product "Adobe Photoshop CS4" shall be added to wishlist
  ...
  Scenario:  Logged User shall add different products to compareList
    ...
    And user click on product "Adobe Photoshop CS4"
    And user click on add to compareList button
    Then product "Adobe Photoshop CS4" shall be added to compareList